...
export default function MultiStepLoaderShowcase() {
  return (
    <main className="min-h-screen bg-[#07090d] px-6 py-10 text-white">
      <div className="mx-auto flex max-w-5xl flex-col gap-8">
        <div>
          ...
          <h1 className="mt-4 text-3xl font-bold">Multi-Step Loader</h1>
          <p className="mt-2 max-w-2xl text-slate-400">A workflow loader for multi-step AI tasks with completed, running, and queued states.</p>
        </div>
