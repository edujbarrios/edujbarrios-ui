...
export default function AboutPage() {
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#40E0D0] sm:tracking-[0.24em]">About / Open Source</p>
      <h1 className="mt-4 text-3xl font-black text-white sm:text-5xl">A small public lab for handcrafted interface pieces.</h1>
      <p className="mt-6 text-base leading-7 text-slate-300 sm:leading-8">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        {values.map((value) => (
          <div key={value} className="glass min-w-0 rounded-lg p-5">
      ...
      <div className="glass mt-10 rounded-lg p-5 sm:p-6">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          <a href={siteConfig.links.github} className="rounded-full bg-[#40E0D0] px-5 py-3 text-center text-sm font-bold text-[#0b0f14]">
            Open GitHub repository
          </a>
          <a href={siteConfig.links.live} className="rounded-full border border-white/12 px-5 py-3 text-center text-sm font-bold text-white">
            Visit live site
          </a>
        </div>
      </div>
